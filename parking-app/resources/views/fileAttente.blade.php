    ...
    <div class="basis-4/5 mt-20">
        ...
        <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5 mt-20">
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                    ...
                    <tr>
                        {{-- <th scope="col" class="px-6 py-4 font-medium text-gray-900">N°reservation</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Utilisateur</th>
                        ...
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">N° rang</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Informations</th>
                        {{-- <th scope="col" class="px-6 py-4 font-medium text-gray-900">N° Place</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Etat</th> --}}
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Date demande</th>
                        {{-- <th scope="col" class="px-6 py-4 font-medium text-gray-900">Date fin</th> --}}
                        {{-- <th scope="col" class="px-6 py-4 font-medium text-gray-900">Edit</th> --}}
