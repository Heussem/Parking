            ...
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                    ...
                    @foreach ($reservations as $reservation)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <strong class="font-black">{{$reservation->user->name}}</strong> / {{$reservation->user->email}}
                            </td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex justify-center gap-4">
                                    ...
                                    <a x-data="{ tooltip: 'Edite' }" href="{{ route('reservation.edit',$reservation->id) }}">
                                        <svg
                                        ...
                                        <a x-data="{ tooltip: 'Delete' }" href="{{ route('cancel', $reservation->id) }}">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
                                                viewBox="0 0 24 24"
